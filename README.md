...
| Machine | Role | OS |
|---------|------|----|
| Attacker VM | Simulates the threat actor | Kali Linux |
| Victim VM | Compromised employee endpoint | Windows |
| Honeypot Server | Fake web server (the trap) | Linux |
| Threat Hunter VM | Monitoring & detection | Kali Linux / Windows |
...
[![Stars](https://img.shields.io/github/stars/youssefhanna-cs/apt-threat-hunting-lab?style=for-the-badge)](https://github.com/youssefhanna-cs/apt-threat-hunting-lab)
